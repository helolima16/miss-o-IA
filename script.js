...
const textoResultado = document.querySelector(".texto-resultado");Sentiu mais facilidade em utilizar seus próprios recursos para escrever seu trabalho.
...
function mostraPergunta() {
    if (atual >= perguntas.length) {onst caixaPrincipal = document.querySelector(".caixa-principal");
    const caixaPerguntas = document.querySelector(".caixa-perguntas");
    const caixaAlternativas = document.querySelector(".caixa-alternativas");
    const caixaResultado = document.querySelector(".caixa-resultado");
